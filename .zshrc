...
export PATH=$PATH:/snap/bin:/home/my/.local/bin:/home/my/go/bin:$JAVA_HOME/bin
...
smbservehere2() {
    ...
    docker run --rm -it -p 445:445 -v "${PWD}:/tmp/serve" smbsevere:latest smbserver.py -smb2support $sharename /tmp/serve
}
smbservehere() {
    local sharename
    [[ -z $1 ]] && sharename="SHARE" || sharename=$1
...
alias js="cat /opt/autotools/js.sh"
